...
<body class="body" background="fondo3.jpg">
	...
	<header>
		...
		<label for="btn-menu" class="icon-menu"></label>
			<nav class="menu">
				<ul>
					...
					<li><a href="http://localhost:8080/proy_progIV%28COPIA%29/html/nosotros.php"><b>Nosotros</b></a></li>

					<li><a  href="http://localhost:8080/proy_progIV%28COPIA%29/html/historia_RCC.php"><b>Historia de RCC</b></a></li>

					<li><a href="http://localhost:8080/proy_progIV(COPIA)/html/galeria_img.php"><b>Galería de imagenes</b></a></li>
		...
		<div id="derecho"> <!--inicio del div derecho-->
			<div id="igle1">
				<img id="dibujo_igle1" src="../imagen/igle1.png"/>
			</div><p>
			<div id="igle2">
				<img id="dibujo_igle2" src="../imagen/igle2.png"/>
			</div>

...
<html>
    <head>
        <title>Pantalla Confirmaciones</title>
        <meta charset="utf8">
        <script type="text/javascript" src="../../js/jquery_p.js"></script>
        <script type="text/javascript" src="../../ModConfirmaciones/js/confirmaciones.js"></script>
        <link rel="stylesheet" href="../../css/estilosFormularios2.css">
    </head>
    <body background="fondo2.jpg">
        <div class="agrupamiento"><!--inicio div agrupamiento-->
            <form id="formSacra">
                <h4>Registro de Confirmaciones</h4>
                <table id="tbpadre">
                    <tr>
                        <td><label>Código</label></td>
                        <td><input type="text"  name="txtCodigoConfirma" id="txtCodigoConfirma" size="9"/></td>
                    </tr>
                    <tr>
                        <td><label>Confirmado/a</label></td>
                        <td><input type="text"  name="txtNombreConfirmado" id="txtNombreConfirmado" size="53"/></td>
                    </tr>
                    <tr>
                        <td>Sacerdote</td>
                        <td><input type="text" name="txtSacerdote" id="txtSacerdote" size="53"/></td>
                    </tr>

...
<html>
    ...
    <body background="fondo2.jpg">
        <div class="agrupamiento"><!--inicio div agrupamiento-->
            <form id="formSacra">
                <h4>Registro de Cargos</h4>
                <table id="tbpadre">
                    <tr>
                        <td><label>Código</label></td>
                        <td><input type="text"  name="txtCodigoCargo" id="txtCodigoCargo" size="9"/></td>
                    </tr>
                    <tr>
                        <td><label>Nombre</label></td>
                        <td><input type="text"  name="txtNombreCargo" id="txtNombreCargo" size="58"/></td>
                    </tr>

                    <tr>
                        <td><label>Estado</label></td>
                        <td><select name="cmbEstadoCargo" id="cmbEstadoCargo" style="width:378px">

...
<html>
    <head>
        <title>Detalle de Matrimonios</title>
        <meta charset="utf8">
    ...
    <body background="fondo2.jpg">
        <div class="agrupamiento"><!--inicio div agrupamiento-->
            <form id="formSacra">
                <h4>Detalle de Matrimonios</h4>
                <table id="tbpadre">
                    <tr>
                        <td><label>Código</label></td>
                        <td><input type="text"  name="txtCodigoDetMatrimonio" id="txtCodigoDetMatrimonio" size="12"/></td>
                    </tr>
                    <tr>
                        <td><label>Nombre</label></td>
                        <td><input type="text"  name="txtNombrePariente" id="txtNombrePariente" size="62"/></td>
                    </tr>
